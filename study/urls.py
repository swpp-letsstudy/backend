...
urlpatterns += [
    ...
    path('cloud_storage/delete/', CloudStorageFileDetail.as_view()),        # DELETE ?groupId=<groupId>&?filepath=<filepath>
    path('cloud_storage/get_url/get/', CloudStorageFileDetail.as_view()),   # POST ?groupId=<groupId>&?filepath=<filepath>
    path('cloud_storage/get_url/upload/', CloudStorageFileCreate.as_view()),# POST ?groupId=<groupId>&?filepath=<filepath>
]
